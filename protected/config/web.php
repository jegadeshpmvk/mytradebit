    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                '/' => 'site/index',
                '<action:(login-form|register-form|forgot-password|cron-jobs|expiry-dates|backup-jobs|logout|web-hooks)>' => 'site/<action>',
                'dashboard' => 'dashboard/index',
                '<action:(account-details)>' => 'dashboard/<action>',
