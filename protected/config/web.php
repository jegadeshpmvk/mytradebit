    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                '<action:(account-details|plans|contact-us|fii-dii|intraday-setups|positional-setups|market-pulse|get-fii-historical|get-market-pulse|options-board)>' => 'dashboard/<action>',
