...
<div class="model_form widgets">
    ...
    <div class="widgets_content">
        <div class="_3_col_form form_widget_group">
            <?= $form->field($model, 'fullname')->textInput(['required' => 'required', 'maxlength' => 255]) ?>
            <?= $form->field($model, 'email')->textInput(['required' => 'required', 'maxlength' => 255]) ?>
            <?= $form->field($model, 'mobile_number')->textInput(['required' => 'required', 'maxlength' => 255]) ?>
...
<div class="options">
    ...
    if (!$model->isNewRecord) {
        echo Html::a('<span>Reset Password</span>', ['customer/password', 'id' => $model->id], ['class' => 'fa fa-unlock']);
    }
    ?>
