    ...
    <div class="dash_sec dash_sec_padd">
        <div class="c">
          ...
          <div class="intra_row" style="margin-top:20px">
                <a class="_col _col_1 intra_row_title">
                    <div class=""><span>Intraday Candlestick Patterns</span></div>
                </a>
                <div class="_col _col_4">
                    <div class="dash_sec_inner">
                        <div class="intra_title">
                ...
                <a class="_col _col_1 intra_row_title">
                    <div class=""><span>Intraday Chart Patterns</span>
                     <div class="intraday_radio">
                         <label>
                                <input name="chart_pattern" class="chart_pattern" checked type="radio" value="Large Cap"><span class="pre_market_radio"></span> <span>Bulish Pattern</span>
                            </label>
                            <label>
                                <input name="chart_pattern" class="chart_pattern" type="radio" value="bearish_pattern"><span class="pre_market_radio"></span> <span>Bearish  Pattern</span>
                            </label>
                            <label>
