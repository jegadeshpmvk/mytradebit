                ...
                <div class="intra_title stocks_type_groups">
                    ...
                    <div class="options_form_group">
                        ...
                        <div class="custom_date_picker <?= date('D'); ?>">
                            ...
                            <input type="text" name="expiry_date" value="<?= $nif_date; ?>" data-expirydate='<?= json_encode($dates); ?>'  readonly="readonly" class="expiry_date_datepicker options_form_control options_board_change" />
                        </div>
                    </div>
                    <div class="options_form_group">
